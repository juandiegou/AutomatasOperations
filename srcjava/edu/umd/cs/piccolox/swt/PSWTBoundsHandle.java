...
public class PSWTBoundsHandle extends PSWTHandle {
  ...
  public static void addBoundsHandlesTo(PNode paramPNode) {
    paramPNode.addChild(new PSWTBoundsHandle(PBoundsLocator.createEastLocator(paramPNode)));
    paramPNode.addChild(new PSWTBoundsHandle(PBoundsLocator.createWestLocator(paramPNode)));
    paramPNode.addChild(new PSWTBoundsHandle(PBoundsLocator.createNorthLocator(paramPNode)));
    paramPNode.addChild(new PSWTBoundsHandle(PBoundsLocator.createSouthLocator(paramPNode)));
    paramPNode.addChild(new PSWTBoundsHandle(PBoundsLocator.createNorthEastLocator(paramPNode)));
    paramPNode.addChild(new PSWTBoundsHandle(PBoundsLocator.createNorthWestLocator(paramPNode)));
    paramPNode.addChild(new PSWTBoundsHandle(PBoundsLocator.createSouthEastLocator(paramPNode)));
    paramPNode.addChild(new PSWTBoundsHandle(PBoundsLocator.createSouthWestLocator(paramPNode)));
  }
  
  public static void addStickyBoundsHandlesTo(PNode paramPNode, PCamera paramPCamera) {
    paramPCamera.addChild(new PSWTBoundsHandle(PBoundsLocator.createEastLocator(paramPNode)));
    paramPCamera.addChild(new PSWTBoundsHandle(PBoundsLocator.createWestLocator(paramPNode)));
    paramPCamera.addChild(new PSWTBoundsHandle(PBoundsLocator.createNorthLocator(paramPNode)));
    paramPCamera.addChild(new PSWTBoundsHandle(PBoundsLocator.createSouthLocator(paramPNode)));
    paramPCamera.addChild(new PSWTBoundsHandle(PBoundsLocator.createNorthEastLocator(paramPNode)));
    paramPCamera.addChild(new PSWTBoundsHandle(PBoundsLocator.createNorthWestLocator(paramPNode)));
    paramPCamera.addChild(new PSWTBoundsHandle(PBoundsLocator.createSouthEastLocator(paramPNode)));
    paramPCamera.addChild(new PSWTBoundsHandle(PBoundsLocator.createSouthWestLocator(paramPNode)));
  }
  ...
  public static void removeBoundsHandlesFrom(PNode paramPNode) {
    ...
    while (listIterator.hasNext()) {
      ...
      if (pNode instanceof PSWTBoundsHandle)
        arrayList.add(pNode); 
    } 
    paramPNode.removeChildren(arrayList);
  }
  
  public PSWTBoundsHandle(PBoundsLocator paramPBoundsLocator) {
  ...
  public void flipSiblingBoundsHandles(boolean paramBoolean1, boolean paramBoolean2) {
    ...
    while (listIterator.hasNext()) {
      PSWTBoundsHandle pSWTBoundsHandle = (PSWTBoundsHandle)listIterator.next();
      if (pSWTBoundsHandle instanceof PSWTBoundsHandle)
        ((PSWTBoundsHandle)pSWTBoundsHandle).flipHandleIfNeeded(paramBoolean1, paramBoolean2); 
    } 
  }
