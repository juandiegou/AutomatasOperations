...
public class PHandle extends PPath {
  ...
  public PHandle(PLocator paramPLocator) {
  ...
  protected void installHandleEventHandlers() {
    this.handleDragger = new PDragSequenceEventHandler(this) {
        ...
        protected void startDrag(PInputEvent param1PInputEvent) {
          ...
          this.this$0.startHandleDrag(param1PInputEvent.getPositionRelativeTo((PNode)this.this$0), param1PInputEvent);
        }
        
        protected void drag(PInputEvent param1PInputEvent) {
          super.drag(param1PInputEvent);
          PDimension pDimension = param1PInputEvent.getDeltaRelativeTo((PNode)this.this$0);
        ...
        protected void endDrag(PInputEvent param1PInputEvent) {
          ...
          this.this$0.endHandleDrag(param1PInputEvent.getPositionRelativeTo((PNode)this.this$0), param1PInputEvent);
        }
      };
